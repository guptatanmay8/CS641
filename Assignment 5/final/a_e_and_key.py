...
keys[1][1]= {(39, 41), (109, 70), (106, 76)}
keys[2][2]= {(43, 43), (55, 86), (29, 108)}
keys[3][3]= {(67, 12), (57, 26), (3, 43)}
keys[4][4]= {(58, 28), (110, 62), (86, 112)}
keys[5][5]= {(41, 11), (17, 51), (69, 53)}
keys[6][6]= {(113, 20), (26, 27), (115, 124)}
keys[7][7]= {(75, 21), (28, 38), (24, 62)}
...
s = to_char(decode("lhihfkmtkikngtmljtlifpfslhgsjtgu"))
print(s)
